...
time = 60*8      # Length of simulation in minutes
...
np.random.seed(1)
grid_agg_ref = np.random.normal(6*num_buildings_small + 30*num_buildings_medium + 50*num_buildings_large, 5.0, int(time/dt) + horiz_len)#*Toa_horiz_normed
