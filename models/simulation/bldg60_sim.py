...
class bldg60_sim:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/10.39]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/1.23]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/10.25]]) # room air to outside air resistance inverse
        ...
        self.C_e_inv = np.array([[1/0.57]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/1.07]]) # external wal to outside air resistance inverse
