...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/23.45]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/3.19]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/4.11]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/858.3]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/15.38]]) # external wal to outside air resistance inverse
