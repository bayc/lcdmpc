...
class bldg62_sim:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/10.56]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/1.25]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/4.85]]) # room air to outside air resistance inverse
        ...
        self.R_ea_inv = np.array([[1/1.79]]) # external wal to outside air resistance inverse
