...
class bldg64_sim:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/3.45]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/2.19]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/9.82]]) # room air to outside air resistance inverse
        ...
        self.C_e_inv = np.array([[1/7.15]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/1000]]) # external wal to outside air resistance inverse
