...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/12.96]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/0.64]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/18.4]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/63.5]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.98]]) # external wal to outside air resistance inverse
