...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/36.45]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/33.67]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/5.31]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/0.208]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.909]]) # external wal to outside air resistance inverse
