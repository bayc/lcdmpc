...
class bldg59_sim:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/5.8]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/8.25]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/1.87]]) # room air to outside air resistance inverse
        ...
        self.C_e_inv = np.array([[1/50.06]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.046]]) # external wal to outside air resistance inverse
