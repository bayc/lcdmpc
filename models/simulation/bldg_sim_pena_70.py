...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/23.5]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/5.02]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/4.42]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/21.5]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/16.7]]) # external wal to outside air resistance inverse
