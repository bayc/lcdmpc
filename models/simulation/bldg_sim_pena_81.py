...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/202.8]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/3.56]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/0.704]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/1.52]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/9.11]]) # external wal to outside air resistance inverse
