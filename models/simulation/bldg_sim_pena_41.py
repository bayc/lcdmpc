...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/1.51]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/2.86]]) # room air to wall resistance inverse
        ...
        self.R_ea_inv = np.array([[1/1.0]]) # external wal to outside air resistance inverse
