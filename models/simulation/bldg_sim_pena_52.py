...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/12.12]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/18.76]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/3.12]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/0.24]]) # external wall equivalent cpaacitance inverse
