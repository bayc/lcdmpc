...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/6.44]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/6.28]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/7.37]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/8.09]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/12.87]]) # external wal to outside air resistance inverse
