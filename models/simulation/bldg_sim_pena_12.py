...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/62.14]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/15.22]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/3.21]]) # room air to outside air resistance inverse
