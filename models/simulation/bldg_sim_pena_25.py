...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/10.1]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/9.74]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/220.48]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/1.92]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/669.85]]) # external wal to outside air resistance inverse
