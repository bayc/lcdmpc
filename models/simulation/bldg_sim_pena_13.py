...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/76.49]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/1.34]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/22.63]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/403.68]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/348.23]]) # external wal to outside air resistance inverse
