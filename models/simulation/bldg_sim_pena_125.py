...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/15.99]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/15.75]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/3.903]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/0.37]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/2554.8]]) # external wal to outside air resistance inverse
