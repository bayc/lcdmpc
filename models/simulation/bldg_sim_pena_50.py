...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/13.65]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/0.77]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/1.34]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/62.5]]) # external wall equivalent cpaacitance inverse
