...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/92.79]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/0.294]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/95.24]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/74.01]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.192]]) # external wal to outside air resistance inverse
