...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/8.24]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/0.725]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/105.8]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/1484.0]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.202]]) # external wal to outside air resistance inverse
