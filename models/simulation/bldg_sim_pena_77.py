...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/45.8]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/1.46]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/1.96]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/78.2]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/1.33]]) # external wal to outside air resistance inverse
