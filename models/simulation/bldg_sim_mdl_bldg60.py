...
class bldg_sim_mdl_bldg60:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[0.0832639467]]) # room air capacitance inverse
        self.R_re_inv = np.array([[0.5025125628]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[0.0954198473]]) # room air to outside air resistance inverse
        # self.R_re_inv = np.array([[1.99]]) # room air to wall resistance inverse
        # self.R_ra_inv = np.array([[10.48]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[0.1016260163]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[0.5102040816]]) # external wal to outside air resistance inverse
        # self.R_ea_inv = np.array([[1.96]]) # external wal to outside air resistance inverse
