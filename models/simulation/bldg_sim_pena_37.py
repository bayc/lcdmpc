...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/9.72]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/2.53]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/0.72]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/76.92]]) # external wall equivalent cpaacitance inverse
