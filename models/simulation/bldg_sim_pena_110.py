...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/10.87]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/3.59]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/6.06]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/129.87]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/1.99]]) # external wal to outside air resistance inverse
