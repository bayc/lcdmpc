...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/14.01]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/10.57]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/0.8]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/1330.38]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.367]]) # external wal to outside air resistance inverse
