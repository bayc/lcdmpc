...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/43.2]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/2.4]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/10.88]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/60.1]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/1.31]]) # external wal to outside air resistance inverse
