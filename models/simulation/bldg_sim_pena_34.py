...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/9768.6]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/3.78]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/0.386]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/0.1457]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.99]]) # external wal to outside air resistance inverse
