...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/59.4]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/27.3]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/1.8]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/34.5]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.096]]) # external wal to outside air resistance inverse
