...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/45.59]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/5.586]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/4.58]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/0.106]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/502.97]]) # external wal to outside air resistance inverse
