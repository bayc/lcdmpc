...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/28.5]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/778.5]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/6.79]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/0.1004]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.33]]) # external wal to outside air resistance inverse
