...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/8.44]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/3.44]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/456.9]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/3.25]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/3.13]]) # external wal to outside air resistance inverse
