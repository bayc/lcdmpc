...
class bldg61_sim:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/4.81]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/2.74]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/2.2]]) # room air to outside air resistance inverse
        ...
        self.C_e_inv = np.array([[1/2.2]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.72]]) # external wal to outside air resistance inverse
