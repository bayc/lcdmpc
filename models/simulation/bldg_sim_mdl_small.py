...
class bldg_sim_mdl_small:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[0.009935]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1.68329]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1.00309]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[0.0001323]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[6.13729]]) # external wal to outside air resistance inverse
