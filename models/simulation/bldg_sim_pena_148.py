...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/109.28]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/1.53]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/9.12]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/26.7]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/8.82]]) # external wal to outside air resistance inverse
