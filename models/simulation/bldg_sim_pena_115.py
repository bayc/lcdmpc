...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/12.31]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/0.78]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/102.04]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/142.8]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/1.95]]) # external wal to outside air resistance inverse
