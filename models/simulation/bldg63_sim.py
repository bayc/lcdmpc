...
class bldg63_sim:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/6.66]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/1000]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/1.12]]) # room air to outside air resistance inverse
        ...
        self.C_e_inv = np.array([[1/11.25]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.097]]) # external wal to outside air resistance inverse
