...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/35.76]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/22.73]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/3.69]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/17.01]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/3.98]]) # external wal to outside air resistance inverse
