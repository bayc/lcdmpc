...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/155.28]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/11.02]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/4.16]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/0.105]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/107.8]]) # external wal to outside air resistance inverse
