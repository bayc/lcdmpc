...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/153.78]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/1.28]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/0.129]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/7.22]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/0.131]]) # external wal to outside air resistance inverse
