...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/214.57]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/0.33]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/0.73]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/26.81]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/20000.0]]) # external wal to outside air resistance inverse
