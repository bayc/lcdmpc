...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[None]]) # room air capacitance inverse
        self.R_re_inv = np.array([[None]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[None]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[None]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[None]]) # external wal to outside air resistance inverse
