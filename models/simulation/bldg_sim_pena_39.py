...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/9.12]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/18.0]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/1.97]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/66.22]]) # external wall equivalent cpaacitance inverse
