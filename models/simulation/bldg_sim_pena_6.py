...
class bldg_sim_pena:
    ...
    def reinit(self):
        ...
        self.C_r_inv = np.array([[1/63.54]]) # room air capacitance inverse
        self.R_re_inv = np.array([[1/21.62]]) # room air to wall resistance inverse
        self.R_ra_inv = np.array([[1/6.23]]) # room air to outside air resistance inverse
        self.C_e_inv = np.array([[1/27.94]]) # external wall equivalent cpaacitance inverse
        self.R_ea_inv = np.array([[1/155.86]]) # external wal to outside air resistance inverse
