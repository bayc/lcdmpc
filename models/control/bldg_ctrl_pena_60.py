...
class bldg_ctrl_pena:
    ...
    def reinit(self, inputs, disturbances):
        ...
        # Model matrices
        self.A = np.array([[0.9991]])
        # coefficients for Q_hvac (-ve value for cooling) - self.mean_inputs(4)
        self.Bu = np.array([[0.0001, 0.0, 0.0]])
        self.Bv = np.array([[0.0]])
        self.Bd = np.array([[0.0001121, 0.0028770000000000002, 0.00023041, 0.0]])
        ...
        self.Bd_mean_inputs = np.array([[20.44], [0.0], [0.0], [0.0]])
