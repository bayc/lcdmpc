...
class bldg_grid_agg_data_driven_bldg60:
    ...
    def process_Q(self, Q):
        ...
        for i in np.arange(0, len(Q), 3):
            ...
            Q[i] = np.zeros(len(Q))
            # else:
                # Q[i] = Q[i]*1.0e-1 # 2.0, -2; 0 for combined opt
