...
class bldg_ctrl_pena:
    ...
    def reinit(self, inputs, disturbances):
        ...
        # Model matrices
        self.A = np.array([[0.9984]])
        # coefficients for Q_hvac (-ve value for cooling) - self.mean_inputs(4)
        self.Bu = np.array([[0.00072088, 0.0, 0.0]])
        self.Bv = np.array([[0.0]])
        self.Bd = np.array([[0.000353, 0.0028018, 0.00015084, 0.0]])
        ...
        self.Bd_mean_inputs = np.array([[nan], [0.0], [0.0], [0.0]])
