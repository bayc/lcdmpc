...
class bldg_ctrl_pena:
    ...
    def reinit(self, inputs, disturbances):
        ...
        # Model matrices
        self.A = np.array([[0.9987]])
        # coefficients for Q_hvac (-ve value for cooling) - self.mean_inputs(4)
        self.Bu = np.array([[0.0007144, 0.0, 0.0]])
        self.Bv = np.array([[0.0]])
        self.Bd = np.array([[0.00031582, 0.003045, 0.000149, 0.0]])
        ...
        self.Bd_mean_inputs = np.array([[20.58], [0.0], [0.0], [0.0]])
